...
public class UserServiceTests
{
    ...
    [Fact(DisplayName = $"{nameof(UserServiceTests)} - {nameof(UserServiceTests.GetByEmailAddressAsyncShouldThrowAnException)} - Should throw an exception")]
    ...
    [Fact(DisplayName = $"{nameof(UserServiceTests)} - {nameof(UserServiceTests.GetByEmailAddressAsyncShouldReturnUser)} - Should return user")]
